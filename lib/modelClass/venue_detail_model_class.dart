class SpecificVenueModelClass {
  ...
  SpecificVenueModelClass({this.id,
    this.venueDetails,
    this.images,
    this.latitude,
    this.longitude,
...
class PitchType {
  ...
  factory PitchType.fromJson(Map json) {
    return PitchType(id: json['id'], name: json['name'], area: json['area']);
  }
}
...
class WeekTimeTable {
  ...
  factory WeekTimeTable.fromJson(Map json) {
    return WeekTimeTable(
      monday:
      json['monday'] == null ? null : TimeTable.fromJson(json['monday']),
      tuesday:
      json['tuesday'] == null ? null : TimeTable.fromJson(json['tuesday']),
      wednesday: json['wednesday'] == null
          ? null
          : TimeTable.fromJson(json['wednesday']),
      thursday: json['thursday'] == null
          ? null
          : TimeTable.fromJson(json['thursday']),
      friday:
      json['friday'] == null ? null : TimeTable.fromJson(json['friday']),
      saturday: json['saturday'] == null
          ? null
          : TimeTable.fromJson(json['saturday']),
      sunday:
      json['sunday'] == null ? null : TimeTable.fromJson(json['sunday']),
    );
  }
}
