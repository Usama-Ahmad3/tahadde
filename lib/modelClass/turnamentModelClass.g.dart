...
part of 'turnamentModelClass.dart';
...
Turnament _$TurnamentFromJson(Map<String, dynamic> json) {
  return Turnament(
    id: json['id'] as int,
    ...
    tournamentfiles: json['tournamentfiles'] == null
        ? null
...
Map<String, dynamic> _$TurnamentToJson(Turnament instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
