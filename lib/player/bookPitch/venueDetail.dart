...
class _VenueDetailScreenState extends State<VenueDetailScreen>
  ...
  late bool _auth;
  SlotPrice _slotPrice = SlotPrice(isPlayer: false,pricePerPlayer: [],pricePerVenue: []);
  ...
  favorite(bool favoriteState) async {
    var detail = {"pitch_id": widget.detail["pitchId"].toString(), "is_favourite": favoriteState};
    ...
    getBytesFromAsset("assets/images/marker.png", 70)
        .then((markerIcon) => setState(() {
              allMarkers.add(Marker(
                ...
                position: LatLng(_venueDetail.latitude!, _venueDetail.longitude!),
              ));
            }));
  }
  ...
  venueDetail() {
    _networkCalls.venueDetail(
        ...
        onSuccess: (detail) {
          setState(() {
            _venueDetail = detail;
           allMarkers.add(Marker(position: LatLng(
               _venueDetail.latitude!,
               _venueDetail.longitude!), markerId: const MarkerId("0")));
            isStateLoading = false;
          });
        },
        onFailure: (msg) {
    ...
    _networkCalls.slotDetail(
        ...
        onSuccess: (detail) {
          setState(() {
            ...
            if (slotModelClass.isNotEmpty && slotModelClass[0].slotDetail!.isNotEmpty) {
              listMaxPlayer = List<int>.generate(
                  slotModelClass[0].slotDetail![0]!.maximumPlayers!.toInt(), (i) => i + 1);
            } else {
              listMaxPlayer.clear();
            }
          });
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            onTap: tabIndex == 0
                                ...
                                : () {
                                    if (_auth) {
                                      if (_slotPrice.pricePerVenue.isEmpty && _slotPrice.pricePerPlayer.isEmpty) {
                                        showMessage(
                                        ...
                                        var detail = {
                                          "price": isPerPlayer?slotPriceCalculation(_slotPrice.pricePerPlayer)*indexItem:slotPriceCalculation(_slotPrice.pricePerVenue),
                                          "apiDetail": apiDetail,
                                          ...
                                          "slug":isPerPlayer?"price-per-player":"venue-price"
                                        };
                            ...
                            child: Container(
                                ...
                                child: tabIndex == 0
                                    ...
                                    :isPerPlayer?_slotPrice.pricePerPlayer.isEmpty? Text(
                                    AppLocalizations.of(context)!.bookNowS,
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize:
                            ...
                            background: Stack(
                              children: [
                                  ...
                                  child: CarouselSlider.builder(
                                      ...
                                      itemBuilder: (BuildContext context,
                                        ...
                                        return cachedNetworkImage(
                                          ...
                                          cuisineImageUrl: _venueDetail.images!
                                ...
                                Positioned(
                                  ...
                                  bottom: 0.0,
                                  child: DotsIndicator(
                                    dotsCount: _venueDetail.images!.files!.length,
                              ...
                              child: SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        padding: const EdgeInsets.all(10),
                                        child: Text(AppLocalizations.of(context)!.facilitiesProvided,
                                            style: const TextStyle(
                                              fontFamily: 'Poppins',
                                              fontSize: 16,
                                              fontWeight: FontWeight.w600,
                                      ...
                                      SizedBox(
                                        ...
                                        child: ListView.builder(
                                            scrollDirection: Axis.horizontal,
                                            itemCount: _venueDetail.venueDetails!.facilities!.length,
                                            itemExtent: itemSize,
                                            controller: _controller,
                                            padding: AppLocalizations.of(context)!.locale=="en"?const EdgeInsets.only(left: 10):const EdgeInsets.only(right: 10),
                                            itemBuilder: (BuildContext context,
                                                int blockIdx) {
                                              return Padding(
                                                padding:
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                        const BorderRadius.only(topRight: Radius.circular(20.0),topLeft: Radius.circular(20.0)),
                                        child: GoogleMap(
                          ...
                          child: Column(
                            children: [
                                                    ...
                                                    dataTime = apiFormatter
                                                        .format(DateTime.now()
                                                            .add(Duration(
                                                                days: index)));
                                                    slotDetail();
                                                    _slotPrice=SlotPrice(pricePerVenue: [],pricePerPlayer: []);
                                                  }
                                                });
                                              },
                                              child: date == index
                              ...
                              Padding(
                                ...
                                child: Row(
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                  children: [
                                    AppLocalizations.of(context)!.locale=="en"?SizedBox(
                                      height: 40,
                                      child: Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.center,
                                        children: [
                                          InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              child: Text(AppLocalizations.of(context)!.perPlayer),
                                            ),
                                          ),
                                          InkWell(
                                            onTap: !isPerPlayer
                                                ? null
                                                : () {
                                              if(_venueDetail.sports!.sportSlug=="swimming"){
                                                showMessage("${AppLocalizations.of(context)!.perVenue} ${AppLocalizations.of(context)!.unavailable} for ${_venueDetail.sports!.name}");
                                              }else{
                                                setState(() {
                                                  _slotTime.clear();
                                                  _slotPrice.pricePerPlayer.clear();
                                            ...
                                            child: Container(
                                              ...
                                              child: Text(AppLocalizations.of(context)!.perVenue),
                                            ),
                                          )
                                        ],
                                      ),
                                    ...
                                    SizedBox(
                                      ...
                                      child: CustomDropdown(
                                        ...
                                        child: Text(
                                          _venueDetail
                                              .venueDetails!.pitchType![0]!.area.toString(),
                                          style: const TextStyle(
                                              fontSize: 12,
                                              color: appThemeColor),
                                        ),
                              ...
                              !isPerPlayer
                                  ...
                                  : listMaxPlayer.isNotEmpty?IgnorePointer(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              AppLocalizations.of(context)!.selectnumberofplayer,
                                              style: const TextStyle(
                                                  color: appThemeColor),
                                            ),
                                            SizedBox(
                                  ...
                                  children: [
                                    slotModelClass.isEmpty
                                        ? SizedBox(
                                            ...
                                            child: Center(
                                              child:
                                                  Text(AppLocalizations.of(context)!.thisDayHoliday),
                                            ),
                                          )
                                        : Padding(
                                                            ...
                                                            child: GridView
                                                                .builder(
                                                                    ...
                                                                    itemBuilder:
                                                                        (context,
                                                                            indexx) {
                                                                      return !slotModelClass[index].slotDetail![indexx]!.isBooked!
                                                                          && availability(slotModelClass[index].slotDetail![indexx])!
                                                                          ? GestureDetector(
                                                                              onTap: () {
                                                                                setState(() {
                                                                                  if (_slotTime.contains(slotModelClass[index].slotDetail![indexx]!.id)) {
                                                                                    _slotTime.remove(slotModelClass[index].slotDetail![indexx]!.id);
                                                                                    _slotPrice.pricePerPlayer.remove(slotModelClass[index].slotDetail![indexx]!.slotPlayerPrice);
                                                                                    _slotPrice.pricePerVenue.remove(slotModelClass[index].slotDetail![indexx]!.slotPrice);
                                                                                    if (slotInformation[slotModelClass[index].sessionName]!.length > 1) {
                                                                                      slotInformation[slotModelClass[index].sessionName]!.remove(slotModelClass[index].slotDetail![indexx]!.startTime);
                                                                                    } else {
                                                                                      slotInformation.remove(slotModelClass[index].sessionName);
                                                                                    }
                                                                                  } else {
                                                                                    _slotTime.add(slotModelClass[index].slotDetail![indexx]!.id!.toInt());
                                                                                    _slotPrice.pricePerPlayer.add(slotModelClass[index].slotDetail![indexx]!.slotPlayerPrice!.toDouble());
                                                                                    _slotPrice.pricePerVenue.add(slotModelClass[index].slotDetail![indexx]!.slotPrice!.toDouble());
                                                                                    if (slotInformation.containsKey(slotModelClass[index].sessionName)) {
                                                                                      slotInformation[slotModelClass[index].sessionName]!.add(slotModelClass[index].slotDetail![indexx]!.startTime.toString());
                                                                                    } else {
                                                                              ...
                                                                              child: _slotTime.contains(slotModelClass[index].slotDetail![indexx]!.id) ?
                                                                              // Container()
                                                                              Container(
                                                                                height: 100,
                                                                                width: 140,
  ...
  void navigateToDetail(Map detail) {
    Navigator.pushNamed(context, RouteNames.enterDetailPitch, arguments: detail);
  }
    ...
    return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildDays( AppLocalizations.of(context)!.monday,_venueDetail.weekTimeTable!.monday),
             _buildDays( AppLocalizations.of(context)!.tuesday,_venueDetail.weekTimeTable!.tuesday),
            _buildDays( AppLocalizations.of(context)!.wednesday,_venueDetail.weekTimeTable!.wednesday),
            _buildDays( AppLocalizations.of(context)!.thursday,_venueDetail.weekTimeTable!.thursday),
            _buildDays(AppLocalizations.of(context)!.friday,_venueDetail.weekTimeTable!.friday),
            _buildDays( AppLocalizations.of(context)!.saturday,_venueDetail.weekTimeTable!.saturday),
            _buildDays( AppLocalizations.of(context)!.sunday,_venueDetail.weekTimeTable!.sunday),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildHolidayStart(venueDay??TimeTable(endTime: '10:00:00',startTime: '10:00:00')),
          _buildHoliday(venueDay??TimeTable(startTime: '10:00:00',endTime: '10:00:00')),
        ],
      ),
    );
  }
  Widget _buildHoliday(TimeTable time){
    return time!=null? Text(time.endTime.toString(),
        style: const TextStyle(
            color: Color(0xFF868686),
            fontSize: 14,
            fontWeight: FontWeight.w500))
  ...
  Widget _buildHolidayStart(TimeTable time){
    return time!=null? Text(time.startTime.toString(),
        style: const TextStyle(
            color: Color(0xFF868686),
            fontSize: 14,
            fontWeight: FontWeight.w500))
...
class SlotPrice{
  ...
  SlotPrice({required this.pricePerPlayer,this.isPlayer=false,required this.pricePerVenue});
