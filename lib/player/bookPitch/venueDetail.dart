                                                  ...
                                                  onTap: !isPerPlayer
                                                      ...
                                                      : () {
                                                          if (_venueDetail
                                                              ...
                                                              "swimming") {
                                                            showMessage(
                                                                "${AppLocalizations.of(context)!.perVenue} ${AppLocalizations.of(context)!.unavailable} for ${_venueDetail.sports!.name}");
                                                          } else {
                                                            setState(() {
                                                              _slotTime.clear();
                                                              _slotPrice
                                                                ...
                                                                .builder(
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return !slotModelClass[index].slotDetail![indexx]!.isBooked! &&
                                                                          ...
                                                                          : !slotModelClass[index].slotDetail![indexx]!.isAvailable!
                                                                              ? Container(
                                                                                  height: 40,
                                                                                  width: 80,
                                                                                  alignment: Alignment.center,
