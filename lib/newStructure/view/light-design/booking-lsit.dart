          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 2*fem, 36*fem),
                width: 375*fem,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(0*fem, 0.5*fem, 16*fem, 0.5*fem),
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(16*fem, 0.5*fem, 0*fem, 0.5*fem),
                      height: double.infinity,
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Center(
                                                    ...
                                                    child: Container(
                                                      margin: EdgeInsets.fromLTRB(1.41*fem, 0*fem, 0*fem, 0*fem),
                                                      child: Text(
                                                        'GR0175',
                                                        textAlign: TextAlign.center,
                                                        style: SafeGoogleFont (
              ...
              Container(
                ...
                margin: EdgeInsets.fromLTRB(20*fem, 0*fem, 40.33*fem, 0*fem),
                width: double.infinity,
                height: 48*fem,
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
