          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                padding: EdgeInsets.fromLTRB(
                    16 * fem, 19 * fem, 21.42 * fem, 19 * fem),
                width: double.infinity,
              ...
              Container(
                ...
                padding:
                    EdgeInsets.fromLTRB(0 * fem, 24 * fem, 0 * fem, 0.14 * fem),
                width: double.infinity,
                decoration: BoxDecoration(
                  color: const Color(0xffffffff),
