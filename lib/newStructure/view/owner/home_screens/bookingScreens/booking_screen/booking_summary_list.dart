...
class _BookingSummaryListState extends State<BookingSummaryList> {
              ...
              : Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: const BorderRadius.only(
                          topLeft: Radius.circular(20),
                          topRight: Radius.circular(20))),
                  child: bookedModel == null || bookedModel.isEmpty
                      ? Column(
                          children: [
                            flaxibleGap(30),
                            SizedBox(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        ...
                                                                        style: Theme.of(context)
                                                                            ...
                                                                            .titleSmall!
                                                                            .copyWith(
                                                                              color: MyAppState.mode == ThemeMode.light ? const Color(0XFF7A7A7A) : Colors.white38,
                                                                              fontFamily: "Poppins",
                                                                            ),
                                                                      ),
                                                                      flaxibleGap(
  ...
  Widget bookingList(sizeWidth, sizeHeight, bookedModel, empty) {
    empty = false;
    return Padding(
